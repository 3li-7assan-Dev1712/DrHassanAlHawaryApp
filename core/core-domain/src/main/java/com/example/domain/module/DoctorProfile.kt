...
val fakeDoctorProfile = DoctorProfile(
    name = "د. حسن الهواري",
    title = "بيانات مؤقتة سيتم استبدالها بالسيرة الذاتية الفعلية للشيخ",
    bio = "د. حسن الهواري هو باحث وأكاديمي متخصص في الدراسات الإسلامية، قضى أكثر من ٢٠ عاماً في تدريس علوم القرآن وتفسيره. له العديد من المحاضرات والدروس العلمية التي تهدف إلى تبسيط مفاهيم القرآن الكريم للشباب المسلم.",
